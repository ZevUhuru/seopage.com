  ...
  return (
    <main className="px-6 py-16 sm:px-10 lg:px-24 lg:py-24">
      ...
      <p className="mt-6 max-w-[620px] text-[19px] leading-[1.55] text-[#C9D0E2]">
        Three directions for the /agentic → /rank redesign. Each has an index and an article view, running on the real articles. The switcher at the bottom keeps your place when you flip styles.
      </p>
